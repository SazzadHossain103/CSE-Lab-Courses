...
# Load images (do this once at the start of your program)
...
life_power_up_image = pygame.image.load("life.png").convert_alpha()

# Scale images to match the dimensions used in the original drawing (optional)
