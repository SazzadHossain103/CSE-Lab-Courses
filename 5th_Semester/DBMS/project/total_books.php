   ...
   <section class="edit-product-form">
      ...
      ?>
               <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <select class="box" name="update_category" value="<?php echo $fetch_update['category']; ?>" required  >
   ...
   <section class="show-products">
      <table>
         ...
         <tbody>
            ...
            ?>
                  <tr>
                     <td><?php echo $fetch_book['bid']; ?></td>
                     <td><img class="books_images" src="added_books/<?php echo $fetch_book['image']; ?>" alt=""></td>
                     <td class="name"><?php echo $fetch_book['name']; ?></td>
                     <td class="name"><?php echo $fetch_book['title']; ?></td>
                     <td class="name"><?php echo $fetch_book['category']; ?></td>
                     <td ><div class="descirption"><?php echo $fetch_book['description']; ?></div></td>
                     <td class="price">TK <?php echo $fetch_book['price']; ?>/-</td>
                     <td><a href="total_books.php?update=<?php echo $fetch_book['bid']; ?>" class="update_btn">update</a></td>
                     <td><a href="total_books.php?delete=<?php echo $fetch_book['bid']; ?>" class="delete_btn" onclick="return confirm('delete this product?');">delete</a></td>
                  </tr>
            <?php
               }
            } else {
