...
<body>
    ...
    <div class="container">
        <form action="" method="post">
            <h3 style="color:white">login to <a href="index.php"><span>BookNest</span></a></h3>
            ...
            <p>Don't have an Account? <br> <a class="link" href="admin_register.php">Sign Up</a><a class="link" href="index.php">Back</a></p>
        </form>
    </div>
