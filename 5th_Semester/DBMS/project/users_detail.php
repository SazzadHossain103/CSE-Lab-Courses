    ...
    <section class="show-products">
        <table>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td class="name"><?php echo $fetch_user['Id']; ?></td>
                            <td class="name"><?php echo $fetch_user['name']; ?>&nbsp;<?php echo $fetch_user['surname']; ?></td>
                            <td class="name"><?php echo $fetch_user['email']; ?></td>
                            <td class="password"><?php echo $fetch_user['password']; ?></td>
                            <td class="price" style="color:<?php if ($fetch_user['user_type'] == 'Admin') {
                                                            echo 'red';
                                                        } else {
                                                            echo 'blue';
                                                        } ?>;"><?php echo $fetch_user['user_type']; ?></td>
                            <td><a style="color:rgb(255, 187, 0);" href="users_detail.php?update_user=<?php echo $fetch_user['Id']; ?>">Update</a></td>
                            <td><a href="users_detail.php?delete_user=<?php echo $fetch_user['Id']; ?>" onclick="return confirm('Are you sure you want to delete this user');">Delete</a></td>
                        </tr>
                <?php
                    }
                } else {
