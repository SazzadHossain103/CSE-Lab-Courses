...
<body>
  ...
  <div class="container">
    <form action="" method="post">
      <h3 style="color:white">Register to Use <a href="index.php"><span>BookNest</span></a></h3>
      ...
      <select name="user_type" id="" required class="text_field select">
        <option value="Admin">Admin</option>
      </select>
      <input type="submit" value="Register" name="submit" class="btn text_field">
      <p>Already have a Account? <br> <a class="link" href="admin_login.php">Login</a><a class="link" href="index.php">Back</a></p>
    </form>
  </div>
